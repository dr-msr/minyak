/**
 * Converts input data to the latest data format version by progressively
 * converting through each previous version.
 *
 * @param input - The input data to convert.
 * @returns The converted data in the latest format version.
 */
...
export function convertData(input: DataType['any']) {
	if (input.Version == defaultData.latest.Version) {
		console.log(
			'%cCONVERT ',
			'color: green;',
			'Reached the latest version. Exiting conversion..'
		);
		console.log(input);
