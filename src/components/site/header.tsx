/**
 * Header component that renders a car animation
 * and title text.
 *
 * Renders Lottie car animation and button with title text.
 * CarAnimation is a separate component that handles
 * configuring and rendering the Lottie animation.
 */
