  ...
  return (
	...
	<div className="grid gap-4 py-4">
	  ...
	  <div className="grid grid-cols-4 items-center gap-4">
		...
		<Input id="1" type="number" value={preset1} onChange={(e) => setPreset1(Number(e.target.value))} className="col-span-3" />
	  </div>
	  ...
	  <div className="grid grid-cols-4 items-center gap-4">
		...
		<Input id="2" value={preset2} onChange={(e) => setPreset2(Number(e.target.value))} className="col-span-3" />
	  </div>
	  ...
	  <div className="grid grid-cols-4 items-center gap-4">
		...
		<Input id="2" value={preset3} onChange={(e) => setPreset3(Number(e.target.value))} className="col-span-3" />
	  </div>
	  ...
	  <div className="grid grid-cols-4 items-center gap-4">
		...
		<Input id="2" value={preset4} onChange={(e) => setPreset4(Number(e.target.value))} className="col-span-3" />
	  </div>
